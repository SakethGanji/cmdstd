...
export class IfNode extends BaseNode {
   ...
   * Has fixed true/false outputs, simpler than Switch
   */
  static readonly nodeDescription: INodeTypeDescription = {
    ...
    properties: [
      {
        displayName: 'Field',
        name: 'field', // ← matches getParameter('field')
        type: 'string',
        default: '',
        placeholder: 'status',
      ...
      },
      {
        ...
        name: 'operation', // ← matches getParameter('operation')
        type: 'options',
        default: 'isTrue',
        options: [
      ...
      {
        displayName: 'Value',
        name: 'value', // ← matches parameter access
        type: 'string',
        default: '',

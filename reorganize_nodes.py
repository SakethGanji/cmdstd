...
This script:
1. Creates category directories (data/, integrations/, output/) with __init__.py
...
6. Removes the old transform/ stub (replaced by data/)
"""
...
CATEGORY_MAP = {
    ...
    # data/ (data manipulation & transformation)
    "set_node": "data",
    "code": "data",
    "filter": "data",
    "item_lists": "data",
...
CATEGORY_META = {
    ...
    "data": "Data nodes — data manipulation, transformation, and storage.",
...
def generate_root_init(categories: dict[str, list[str]]) -> str:
    ...
    category_order = ["triggers", "flow", "data", "integrations", "ai", "output"]
...
def main():
    ...
    for d in ["data", "integrations", "output"]:
